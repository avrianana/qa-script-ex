...
class Webdriver(unittest.TestCase):
    ...
    def test_url_function(self):
        ...
        # test click add review
        print("Add Review")
        driver.execute_script("window.scrollBy(0,200);")
        time.sleep(2)
        print("success smooth scrolling the page")
        # test click to add review for create review
        elem = driver.find_element_by_xpath("//button[@class='jsx-2599477350 pr-btn']")
        elem.click()
        time.sleep(2)
        print("success click to add review for create review")
        # test smooth scrolling through the page
        driver.execute_script("window.scrollBy(0,200);")
        time.sleep(2)
        print("success smooth scrolling through the page")

        # test search box filter by brand
        print("Search Box Filter By Brand")
        elem = driver.find_element_by_xpath("//input[@placeholder='Search products']")
        elem.send_keys("Lipstick")
        time.sleep(2)
        elem.send_keys(Keys.ENTER)
        time.sleep(5)
        print("success search box find product")
        ...
        # # test click change product
        # print("Change Product")
        # elem = driver.find_element(By.XPATH, '//span[text()="CHANGE PRODUCT"]')
        # elem.click()
        # time.sleep(2)
        # print("success click to change product")
        # test for add review
        print("Add Review")
        ...
        elem.click()
        elem.send_keys(
            "Product ini bagus banget dari berbagai segi. Harganya, bentuk atau packagingnya, teksturnya, cocok banget untuk kulitku. Product ini sama sekali gak bermasalah dikulitku, gangerti kenapa product sebagus ini harganya sangat amat terjangkau. Pokoknya love banget deh!")
        time.sleep(2)
        print("success typing review example")
